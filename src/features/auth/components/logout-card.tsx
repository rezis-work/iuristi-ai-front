        ...
        <Card className="bg-gray-900/95 backdrop-blur-sm shadow-2xl border-gray-800/50 py-20">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={isPending}
              variant="destructive"
              className="w-full h-13 transition-all duration-200 font-semibold text-base rounded-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
            >
